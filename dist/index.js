  ...
  var FileInput = function (_React$Component) {
    ...
    _createClass(FileInput, [{
      ...
      value: function render() {
        ...
        var fileList = this.state.files && Object.keys(files).map(function (key) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'simple-react-file-uploader-icon', id: 'simple-react-file-uploader-icon' },
              _react2.default.createElement('img', { className: 'file', src: _file2.default, alt: files[key].name, id: 'file' }),
              _react2.default.createElement(
                'p',
                { className: 'file-name' },
                files[key].name
              ...
              _react2.default.createElement('span', { onClick: function onClick() {
                  return _this2.handleDeleteFile(key);
                } })
            )
          );
        });
        ...
        return _react2.default.createElement(
          'div',
          { id: 'simple-react-file-upload', className: this.props.className ? this.props.className + ' simple-react-file-upload' : 'simple-react-file-upload' },
          _react2.default.createElement(
            'div',
